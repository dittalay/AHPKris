...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        return view('admin.dashboard', compact(
            'propertycount', 'commentcount', 'usercount',
            'properties',     'users',        'comments'
        ));
    }
    ...
    public function messageSend(Request $request)
    {
        ...
        Toastr::success('message', 'pesan sukses terkirim.');
        return back();
    ...
    public function contactMail(Request $request)
    {
        ...
        Mail::to($request->email)->send(new Contact($message,$nama,$mailfrom));

        Toastr::success('message', 'EMAIL Berhasil Terkirim.');
        return back();
    }
