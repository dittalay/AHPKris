<ul class="collection with-header">
        ...
        <li class="collection-header center">
            <div class="m-t-10">
                <img src="{{Storage::url('users/'.auth()->user()->image)}}" alt="{{ auth()->user()->nama }}" class="circle responsive-img">
            </div>
            <h5 class="truncate">
                {{ auth()->user()->nama }}
            </h5>
        ...
        <a href="{{ route('user.nilai-kriteria.new') }}">
            <li class="collection-item {{ Request::is('user/nilai-kriteria') ? 'active' : '' }}">
                <i class="material-icons left">star</i>
                <span>Rumah Khusus Untuk Anda<span>
            </li>
        </a>
