    <nav class="navbar">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('admin.dashboard') }}">WELCOME BACK TO ADMIN</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="{{ route('admin.message') }}">Lihat Semua Pesan</a>
                            </li>
                        </ul>
                    </li>
                    <!-- #END# Notifications -->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li>
                                <a href="{{ route('admin.message') }}"><i class="material-icons">message</i>Pesan</a>
                            </li>
                            <li>
                                <a href="{{ route('home') }}" target="_blank"><i class="material-icons">home</i>Kunjungi Website</a>
                            </li>
                            <li role="seperator" class="divider"></li>
