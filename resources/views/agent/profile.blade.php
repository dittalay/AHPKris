                        ...
                        <form action="{{route('agent.profile.update')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    ...
                                    <input id="nama" name="nama" type="text" value="{{ $profile->nama }}" class="validate">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <textarea id="deskripsi" name="deskripsi" class="materialize-textarea">{{ $profile->deskripsi or null }}</textarea>
