        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m9">
                    ...
                    <h4 class="agent-title">DASHBOARD DEVELOPER PERUMAHAN</h4>
                        ...
                        <div class="row">
                            <div class="col s6">
                                <div class="box indigo white-text p-30">
                                    ...
                                    <span class="truncate uppercase bold font-18">Rumah</span>
                            ...
                            <div class="col s6">
                                <div class="box indigo white-text p-30">
                                    ...
                                    <span class="truncate uppercase bold font-18">Pesan</span>
                        ...
                        <div class="row">
                            <div class="col s6">
                                <div class="box indigo white-text p-20">
                                    ...
                                    <span class="truncate uppercase bold">Recent Rumah</span>
                                </div>
                                <div class="box-content">
                                    ...
                                    <div class="grey lighten-4">
                                        <a href="{{route('property.show',$property->slug)}}" target="_blank" class="border-bottom display-block p-15  grey-text-d-2">
                                            {{ ++$key }}. {{ str_limit($property->nama_rumah, 28) }}
                                            <span class="right">&dollar;{{ $property->harga_rumah }}</span>
                                        </a>
                                    </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="col s6">
                                <div class="box indigo white-text p-20">
                                    ...
                                    <span class="truncate uppercase bold">Recent E-Mail</span>
                                </div>
                                <div class="box-content">
                                    @foreach($messages as $message)
                                    <div class="grey lighten-4">
                                        <a href="" class="border-bottom display-block p-15 grey-text-d-2">
                                            <strong>{{ strtok($message->nama, " ") }}:</strong>
