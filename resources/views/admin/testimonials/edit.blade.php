...
@section('content')
    ...
    <div class="block-header">
        <a href="{{route('admin.testimonials.index')}}" class="waves-effect waves-light btn right m-b-15 addbtn">
                ...
                <div class="body">
                    <form action="{{route('admin.testimonials.update',$testimonial->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="form-line">
                                <input type="text" name="nama" class="form-control" value="{{$testimonial->nama}}">
                            </div>
                        </div>
