...
@section('content')
    ...
    <div class="block-header">
        <a href="{{route('admin.testimonials.create')}}" class="waves-effect waves-light btn right m-b-15 addbtn">
            ...
            <span>MEMBUAT DATA TESTIMONIAL BARU </span>
        </a>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(Storage::disk('public')->exists('testimonial/'.$testimonial->image))
                                            <img src="{{Storage::url('testimonial/'.$testimonial->image)}}" alt="{{$testimonial->nama}}" width="160" class="img-responsive img-rounded">
                                        @endif
                                    </td>
