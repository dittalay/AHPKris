...
<div class="block-header">
    <a href="{{route('admin.sliders.index')}}" class="waves-effect waves-light btn right m-b-15 addbtn">
                ...
                <div class="body">
                    <form action="{{route('admin.sliders.update',$slider->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="form-line">
                                <input type="text" name="nama" class="form-control" value="{{$slider->nama}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-line">
                                <textarea name="deskripsi" rows="4" class="form-control no-resize">{{$slider->deskripsi}}</textarea>
                            </div>
                        </div>
